...
def reiniciar_jogo(dino, cacto, dino_voador):
    global pontos, colidiu, velocidade_jogo, escolha_obstaculo
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_r and colidiu == True:
                    reiniciar_jogo(dino, cacto, dino_voador)
